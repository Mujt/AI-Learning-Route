# MCP 知识要点（万字拆解 MCP 协议）

> 原文来源：JavaGuide（https://javaguide.cn/ai/agent/mcp.html）
...
![mcp-fc-agent-layer.png](images/mcp-fc-agent-layer.png)
...
![mcp-four-layer-architecture.png](images/mcp-four-layer-architecture.png)
...
![mcp-call-seq.png](images/mcp-call-seq.png)
...
![mcp-transport-decision.png](images/mcp-transport-decision.png)
...
Prompt Injection、Token Passthrough、资源级鉴权、本地 Server 隔离和第三方 Skill/MCP 供应链的完整链路，可以继续看 [LLM/Agent 安全实战](/ai/system-design/llm-security.html)。
